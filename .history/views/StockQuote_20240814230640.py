...
class StockQuotes(MDScreen):
    ...
    def handle_submit(self, instance):
        ...
        try:
            ...
            last_queried = response["processedTime"]
            ent_value = response["body"]["enterpriseValue"]["fmt"]
            forward_pe = response["body"]["enterpriseValue"]["forwardPE"]["fmt"]
            profit_margins = response["body"]["enterpriseValue"]["profitMargins"]["fmt"]
            float_shares = response["body"]["enterpriseValue"]["floatShares"]["fmt"]

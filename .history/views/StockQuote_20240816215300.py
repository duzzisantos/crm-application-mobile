...
class StockQuotes(MDScreen):
    def __init__(self, sm, **kwargs):
        ...
        place_holder = Label(text="placeholder")
    ...
    def handle_submit(self, instance):
        ...
        try:
            ...
            headers = {
                "x-rapidapi-key": "Please obtain your API key from Rapid API",
            ...
            print(
                "The stock quotes are not available at the moment. You may want to obtain your API key here: https://www.radipapi.com!"
            )

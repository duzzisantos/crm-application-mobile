...
class StockQuotes(MDScreen):
    ...
    def handle_submit(self, instance):
        ...
        try:
            ...
            last_queried = response["meta"]["processedTime"]
            ent_value = response["meta"]["body"]["enterpriseValue"]["fmt"]
            forward_pe = response["meta"]["body"]["enterpriseValue"]["forwardPE"]["fmt"]
            profit_margins = response["meta"]["body"]["enterpriseValue"][
                "profitMargins"
            ]["fmt"]
            float_shares = response["meta"]["body"]["enterpriseValue"]["floatShares"][
                "fmt"
            ]

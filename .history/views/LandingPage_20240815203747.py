...
class LandingPage(GridLayout):
    def __init__(self, sm, **kwargs):
        ...
        ##Marketing Funnel
        self.marketingFunnelBtn = Button(
            text="Marketing Funnel",
            font_size=40,
            background_color="#06aed5",
            bold=True,
        )
        self.marketingFunnelBtn.bind(on_press=self.showMarketingFunnel)
        self.add_widget(self.marketingFunnelBtn)

        ##Marketing Funnel
        self.marketSegmentationBtn = Button(
            text="Market Segmentation",
            font_size=40,
            background_color="#004e89",
            bold=True,
        )
        self.marketSegmentationBtn.bind(on_press=self.showMarketSegmentation)
        self.add_widget(self.marketSegmentationBtn)
    ...
    def showMarketingFunnel(self, instance):
        self.sm.current = "marketing_funnel"

    def showMarketSegmentation(self, instance):
        self.sm.current = "segmentation"
...
class MyApp(MDApp):
    def build(self):
        ...
        sm.add_widget(Segmentation.Segmentation(sm=sm, name="segmentation"))

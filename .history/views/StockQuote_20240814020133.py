...
class StockQuotes(MDScreen):
    def __init__(self, sm, **kwargs):
        ...
        form_label = Label(text="Enter stock quote. Eg: AMZN")
        form_input = TextInput(multiline=False)
        submit_btn = Button(font_size=25, text='Search')
        layout.add_widget(form_label)
        layout.add_widget(form_input)
        ...
        try:
            ...
            querystring = {"ticker": "AAPL", "module": "statistics"}
    ...
    def change_text(instance, value):

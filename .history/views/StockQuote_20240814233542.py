...
class StockQuotes(MDScreen):
    def __init__(self, sm, **kwargs):
        ...
        try:
            ...
            querystring = {"ticker": str(self.form_input.text), "module": "statistics"}
            ...
            layout.add_widget(self.stock_table)
            self.add_widget(self.stock_table)

        except:
            raise Exception(
                "Either stock quotes are not available at the moment or there's a breakdown in service!"
            )

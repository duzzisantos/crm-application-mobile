    ...
    def __init__(self, sm, **kwargs):
        ...
        try:
            ...
            aggregate_table_row_data = [
                (region, values["state_count"], values["total_customer_size"])
            ...
            self.label_1 = Label(text="Segmentation By State and Region", font_size=20)
            self.label_2 = Label(text="Segmentation Region Only", font_size=20)

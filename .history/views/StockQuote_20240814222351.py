...
class StockQuotes(MDScreen):
    def __init__(self, sm, **kwargs):
        ...
        innerLayout = BoxLayout(orientation="vertical", padding=[40, 80])
        buttonLayout = BoxLayout(
            orientation="vertical", padding=[0, 5], background_color="yellow"
        )
        ...
        buttonLayout.add_widget(self.submit_btn)
        buttonLayout.add_widget(self.form_label)
        innerLayout.add_widget(buttonLayout)

        self.form_label = Label(text="Enter stock quote. Eg: AMZN", font_size=25)
        innerLayout.add_widget(self.form_label)

...
class LandingPage(GridLayout):
    def __init__(self, sm, **kwargs):
        ...
        ##Marketing Funnel
        self.marketingFunnel = Button(
            text="Marketing Funnel",
            font_size=40,
            background_color="#06aed5",
            bold=True,
        )
        self.marketingFunnel.bibd(on_press=self.showMarketingFunnel)
        self.add_widget(self.marketingFunnel)

        ##Marketing Funnel
        self.marketSegmentation = Button(
            text="Market Segmentation",
            font_size=40,
            background_color="#2f3061",
            bold=True,
        )
        self.marketSegmentation.bind(on_press=self.showMarketSegmentation)
        self.add_widget(self.marketSegmentation)

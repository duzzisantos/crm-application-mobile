...
class LandingPage(GridLayout):
    def __init__(self, sm, **kwargs):
        ...
        self.customersBtn = Button(
            text="Customers", font_size=40, background_color="#2f3061", color="white"
        )
        ...
        self.enrollmentBtn = Button(
            text="Enrollments", font_size=40, background_color="#222a68"
        )
        ...
        self.productsBtn = Button(
            text="Products", font_size=40, background_color="#004e89"
        )
        self.productsBtn.bind(on_press=self.showProducts)
        self.add_widget(self.productsBtn)

        ##Stock quotes
        self.stockQuotesBtn = Button(text="Stock Quotes", font_size=40)

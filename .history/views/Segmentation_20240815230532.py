...
class Segmentation(MDScreen):
    def __init__(self, sm, **kwargs):
        ...
        try:
            ...
            ## Final aggregated result to fit into table data structure
            final_result = []
            for x in regional_overview.keys():
                for y in regional_overview.values():
                    final_result.append(
                        {
                            "region": x,
                            "state_count": y["state_count"],
                            "total_customer_size": y["total_customer_size"],
                        }
                    )
            ...
            ## Display tables on layout and class itself
